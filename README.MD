...
- **Multiple statements**: You can call several functions during an interation using `comma`
```javascript
  let counter = 0;
  function inc() {
    counter++;
...
```
- This can be also achived using `for...in` loop, this will help to avoid use any of the Object conversion method
